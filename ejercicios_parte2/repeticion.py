...
of frost and desolation
it ever presents itself to my imagination as the
...
navigators--there snow and frost are banished
...
months are requisite
or by ascertaining the secret of the magnet, which,
...
but my hopes fluctuate, and my spirits
...
separar = texto.split()
contador = Counter(separar)
mas_repetida = contador.most_common(1)
for letra, valor in mas_repetida:
  print("La letra o palabra más repetida es: '{}', fue repetida {} veces".format(letra,valor))
